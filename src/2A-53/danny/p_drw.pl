...
$prog  = "2A53";
$zr    = "/usr/people/trmm/win/zr/zr_test8.out";
$gauge = "/dat4/trmm/AIW/gauge/darwin/dar_sitelist95";
#$win   = "gwin/gwin.out";
$win   = "gwin.out";

$options = " -b 1.5 -f 4.0 -n 0 -p 1000 -t 303 -d 295 -z $zr -g $gauge -w $win -k 300. -a 1.4 -m 1 -c";
